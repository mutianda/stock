<template>
    <div :class="[prefixCls+'mask']" v-if="show">
        <div :class="[prefixCls+'box']" :style="modalStyle" @dragstart="handleMoveStart" draggable="true" @dragend="handleMoveEnd">
            <div :class="[prefixCls+'header']">
                ...
                <i class="el-icon-close close-icon" @click="closeModal" draggable="false"></i>
            </div>
	...
	export default {
        ...
        methods:{
            ...
            handleMoveEnd(e){
                ...
                this.style.left +=this.dragDetail.dragEnd.x-this.dragDetail.dragStart.x
            },
            closeModal(){
